...
LSM9DS1Class::LSM9DS1Class(TwoWire &wire) : continuousMode(false), _wire(&wire)
{
}
...
int LSM9DS1Class::setAccelODR(uint8_t range) // Sample Rate 0:off, 1:10Hz, 2:50Hz, 3:119Hz, 4:238Hz, 5:476Hz, 6:952Hz
{
  ...
  if (writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG6_XL, setting) == 0)
    return 0;
...
{
  if (!readRawGyro(x, y, z))
    return 0; // get the register values
...
{
  if ((readRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG6_XL) & 0b11100000) == 0)
    return 0;
