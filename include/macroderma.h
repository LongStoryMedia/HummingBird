...
#define MAX_ROLL 20.0f         // Max roll angle in degrees for angle mode (maximum 60 degrees), deg/sec for rate mode
#define MAX_PITCH 20.0f        // Max pitch angle in degrees for angle mode (maximum 60 degrees), deg/sec for rate mode
#define MAX_YAW 120.0f         // Max yaw rate in deg/sec
...
#define B_LOOP_ROLL 0.85f      // Roll damping term for controlANGLE2(), lower is more damping (must be between 0 to 1)
...
#define B_LOOP_PITCH 0.85f     // Pitch damping term for controlANGLE2(), lower is more damping (must be between 0 to 1)
#define KP_ROLL_RATE 0.03f     // Roll P-gain - rate mode
#define KI_ROLL_RATE 0.015f    // Roll I-gain - rate mode
#define KD_ROLL_RATE 0.00002f  // Roll D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
#define KP_PITCH_RATE 0.03f    // Pitch P-gain - rate mode
#define KI_PITCH_RATE 0.015f   // Pitch I-gain - rate mode
#define KD_PITCH_RATE 0.00002f // Pitch D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
#define KP_YAW 0.2f            // Yaw P-gain
#define KI_YAW 0.15f           // Yaw I-gain
#define KD_YAW 0.00002f        // Yaw D-gain (be careful when increasing too high, motors will begin to overheat!)
