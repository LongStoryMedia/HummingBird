...
#define B_LOOP_ROLL 0.6f      // Roll damping term for controlANGLE2(), lower is more damping (must be between 0 to 1)
...
#define KP_ROLL_RATE 0.125f   // Roll P-gain - rate mode
#define KI_ROLL_RATE 0.2f     // Roll I-gain - rate mode
#define KD_ROLL_RATE 0.0008f  // Roll D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
#define KP_PITCH_RATE 0.15f   // Pitch P-gain - rate mode
#define KI_PITCH_RATE 0.25f   // Pitch I-gain - rate mode
#define KD_PITCH_RATE 0.0008f // Pitch D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
