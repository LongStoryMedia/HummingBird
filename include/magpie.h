...
#define KI_PITCH_ANGLE 0.225f // Pitch I-gain - angle mode
...
#define KI_ROLL_RATE 0.05f    // Roll I-gain - rate mode
#define KD_ROLL_RATE 0.0001f  // Roll D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
#define KP_PITCH_RATE 0.1f    // Pitch P-gain - rate mode
#define KI_PITCH_RATE 0.05f   // Pitch I-gain - rate mode
#define KD_PITCH_RATE 0.0001f // Pitch D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
