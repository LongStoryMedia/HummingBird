...
#define KI_PITCH_ANGLE 0.3f  // Pitch I-gain - angle mode
...
#define KI_ROLL_RATE 0.01f   // Roll I-gain - rate mode
#define KD_ROLL_RATE 0.001f  // Roll D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
#define KP_PITCH_RATE 0.03f  // Pitch P-gain - rate mode
#define KI_PITCH_RATE 0.01f  // Pitch I-gain - rate mode
#define KD_PITCH_RATE 0.001f // Pitch D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
